...
def parse_args():
    ...
    parser.add_argument("--namespace", "-n", type=str, help='Namespace to filter. Default to current namespace', default=None)
    parser.add_argument("--all-namespaces", action='store_true', help='Watch all namespaces. Take priority over --namespace')
