...
func (r *ResourceWatcher) GetWatchConfigs(nodePollingPeriod time.Duration, namespacePollingPeriod time.Duration) []watchConfig {
	...
	batchGetter := r.clientset.BatchV1beta1().RESTClient()
	...
	watchConfigs := []watchConfig{
		...
		watchConfig{k8sresources.NewCronJobFromRuntime, k8sresources.CronJobHeader, "cronjobs", batchGetter, &batchbetav1.CronJob{}, true, 0},
